...
const profiles = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current">
        <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104 5.35 5.35 0 0 0-.125.513 5.527 5.527 0 0 0 .062 2.362 5.83 5.83 0 0 0 .349 1.017 5.938 5.938 0 0 0 1.120 1.615l3.854 4.126 5.406 5.788a1.374 1.374 0 0 0 2.035-1.848l-5.406-5.788-3.854-4.126a3.5 3.5 0 0 1 0-4.908l3.854-4.126 5.406-5.788A1.374 1.374 0 0 0 13.483 0zm6.517 9.5h-8v3h8a1.5 1.5 0 0 0 0-3z"/>
      </svg>
    ),
  },
  {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {profiles.map((profile, index) => (
              <a
                ...
                className="group relative p-6 bg-card border border-border rounded-xl hover:border-transparent transition-all duration-300 overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="text-foreground group-hover:text-primary transition-colors mb-4">
                    {profile.icon}
                  </div>
